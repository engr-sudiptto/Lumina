  ...
  return (
    <div>
      ...
      <section className="flex flex-col w-full h-auto items-center justify-center m-auto gap-10 lg:h-screen xl:flex-row xl:gap-0 xl:pt-30 xl:w-[80%] xl:mb-30 xl:h-175 xl:items-start ">
        <div className="flex gap-2 flex-col w-full xl:h-157 xl:max-w-150 xl:shadow-xl xl:pb-3">
          <img
        ...
        <form className=" w-[95%] max-w-150 h-auto p-3 bg-blue-50 rounded-xl mb-10 sm:px-15 sm:py-5 xl:h-157">
          ...
          <p className="text-center mt-6 mb-3 text-gray-400 text-sm">
            ...
            <Link to="/login" className="text-base text-blue-400 underline">
              Login Now
            </Link>{' '}
          </p>
        </form>
