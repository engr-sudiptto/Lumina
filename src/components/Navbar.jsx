...
const Navbar = () => {
  ...
  return (
    <div className="overflow-x-clip">
      <section className="flex items-center justify-between w-full h-13 px-5 lg:px-15 lg:h-15 xl:px-25 xl:h-15 2xl:h-20 2xl:px-35 fixed z-100 bg-linear-to-r from-black/50 to-white/90">
        ...
        <nav>
          ...
          <ul
            className={`flex flex-col gap-7 h-screen w-65 fixed top-0 p-10 bg-linear-to-br from-[#00508299] via-[#3385b5] to-[#7db9e899] transition-right duration-700 ease-in-out z-100 ${isOpen ? 'right-0 sm:right-0' : '-right-65 sm:-right-80'} sm:w-80 lg:relative lg:flex-row lg:h-full lg:top-0 lg:left-0 lg:right-0 lg:w-full lg:items-center lg:justify-center lg:gap-15 lg:p-0 lg:bg-none`}
          >
            {/* Close Cross Icon */}
            <svg
              onClick={() => setIsOpen(false)}
              ...
              stroke-width="2"
              stroke="currentColor"
              className="size-7 lg:hidden text-white"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <Link
              to="/"
              className="font-semibold text-white lg:text-[15px] group relative lg:text-teal-700 2xl:text-[17px]"
            >
              Home
